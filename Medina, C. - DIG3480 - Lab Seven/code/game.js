...
function Fireball(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.8, 0.4));   //Modify
  this.size = new Vector(0.8, 0.8); //Modify
  // Make it go back and forth in a sine wave.
  this.wobble = Math.random() * Math.PI * 2;
}
...
Level.prototype.playerTouched = function(type, actor) {   //Need to make it so fireball resets the player to starting pos. Later...
  if (type == "coin" || "fireball") {
